...
const CreatePodcast = ()=> {
  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      console.log(error)
      toast({
        title: "Error in creating podcast",
        variant: "destructive",
      })
      setIsSubmitting(false)
    }
          ...
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value)=> setVoiceType(value)}>
                ...
                <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus-visible:ring-offset-orange-focus-visible:ring-offset-orange-1">
