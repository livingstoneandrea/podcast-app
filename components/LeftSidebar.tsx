    ...
    <section className={cn("left_sidebar h-[calc(100vh-5px]", {"h-[calc(100vh-140px]": audio?.audioUrl})} >
        <nav className="flex flex-col gap-6">
            ...
            {sidebarLinks.map(({route, label, imgURL}) => {
                ...
                return <Link key={label} href={route} className={cn("flex gap-3 items-center py-4 max-lg:justify-center lg:justify-start", {
        ...
        <SignedOut>
            <div className="flex-center w-full pb-14 max-lg:px-4 lg:pb-8">
